...
import com.salman.mymovieapp.activity.VideoPlayActivity;
import com.salman.mymovieapp.model.MovieVideosResults;
import com.salman.mymovieapp.viewholder.MovieVideosViewHolder;
    ...
    public void onBindViewHolder(@NonNull final MovieVideosViewHolder movieVideosViewHolder, int i) {
        ...
        movieVideosViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // set animation to open the vidoe
                ActivityOptionsCompat compat = ActivityOptionsCompat.makeSceneTransitionAnimation(activity, movieVideosViewHolder.thumbnailView,
                        ViewCompat.getTransitionName(movieVideosViewHolder.thumbnailView));

                //put the current video postion and video list
